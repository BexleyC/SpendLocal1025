...
interface TewksburySiteProps {
  onTownChange: (town: Town) => void;
}

export default function TewksburySite({ onTownChange }: TewksburySiteProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-8">
            <div className="flex flex-col bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <p className="mt-4 text-gray-300">
                Direct delivery to ~10,000 Tewksbury, MA homes and businesses every month, ensuring your message reaches your local customer base.
              </p>
            </div>
            <div className="flex flex-col bg-white/10 backdrop-blur-sm rounded-2xl p-8">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-white text-4xl font-bold tracking-wider">TEWKSBURY, MA</span>
            </div>
      ...
      {/* Contact Form Modal */}
      {showContactForm && (
        <ContactForm onClose={() => setShowContactForm(false)} townName="Tewksbury" />
      )}
    </div>
  );
}