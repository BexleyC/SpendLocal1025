...
export function NorthAndoverCoupons() {
  ...
  const coupons = [
    {
      id: 1,
      business: "North Andover Pizzeria",
      offer: "Free Appetizer with Purchase of $25+",
      code: "FREEAPP",
      expiry: "August 31, 2025",
      description: "Valid for dine-in only. Up to $10 value. Cannot be combined with other offers.",
    ...
    {
      id: 2,
      business: "North Andover Tire & Auto",
      offer: "$10 Off Any Oil Change",
      code: "OIL10",
      expiry: "September 30, 2025",
      description: "Valid for conventional oil changes. Additional fee for synthetic oil.",
      logo: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      category: "Automotive"
    },
    {
      id: 3,
      business: "North Andover Bookstore",
      offer: "Buy 2 Books, Get 1 Free",
      code: "BOOK3",
      expiry: "July 31, 2025",
      description: "Free book must be of equal or lesser value. Valid on in-stock items only.",
      logo: "https://images.unsplash.com/photo-1526243741027-444d633d7365?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      category: "Retail"
    },
    {
      id: 4,
      business: "North Andover Hair Salon",
      offer: "20% Off First-Time Haircut",
      code: "NEWHAIR20",
      expiry: "October 31, 2025",
      description: "New clients only. By appointment only. Mention code when booking.",
      logo: "https://images.unsplash.com/photo-1560066984-138dadb4c035?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      category: "Beauty"
    },
    {
      id: 5,
      business: "North Andover Yoga Studio",
      offer: "First Class Free",
      code: "FIRSTYOGA",
      expiry: "December 31, 2025",
      description: "New students only. Reservation required. Valid for any regular class.",
      logo: "https://images.unsplash.com/photo-1575052814086-f385e2e2ad1b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      category: "Health & Fitness"
    },
    {
      id: 6,
      business: "North Andover Ice Cream Shop",
      offer: "Buy One Cone, Get One 50% Off",
      code: "ICECREAM50",
      expiry: "August 15, 2025",
      description: "Valid for any size cone. Second cone must be of equal or lesser value.",
      logo: "https://images.unsplash.com/photo-1501443762994-82bd5dace89a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      category: "Food"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      <SEOHelmet 
        town="northandover" 
        pageTitle={`${currentMonth} Coupons for North Andover, MA | SPENDLOCAL`}
        pageDescription={`Exclusive deals and discounts from North Andover businesses for ${currentMonth}. Save money while supporting your local community.`}
      />
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col items-center text-center">
            <Link to="/northandover" className="flex items-center text-white hover:text-blue-200 transition-colors mb-6">
              <ArrowLeft className="w-5 h-5 mr-2" />
              Back to North Andover
            </Link>
            <h1 className="text-4xl font-bold mb-4">{currentMonth} Coupons for North Andover, MA</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <span className="text-xl font-bold">SPENDLOCAL NORTH ANDOVER</span>
            </div>
